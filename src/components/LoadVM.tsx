            ...
            {executed && (
                <>
                    <div className="flex items-center gap-4">
                        <button className="rounded-xl border-explore p-4" onClick={() => instantiate(pushState, pushEvent, states, {
                            name: 'Picasso',
                            symbol: 'PICA',
                            decimals: 12,
                            initial_balances: [],
                        ...
                        <button className="rounded-xl border-explore p-4" onClick={() => execute(pushState, pushEvent, states, {
                            mint: {
                                recipient: "10001",
                                amount: "5555"
                            }
